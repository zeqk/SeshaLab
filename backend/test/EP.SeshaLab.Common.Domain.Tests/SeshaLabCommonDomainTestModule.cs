...
using EP.SeshaLab.Tests.DependencyInjection;
using Shesha;
...
namespace EP.SeshaLab.Common.Tests
{
    [DependsOn(
    ...
    public class SeshaLabCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public SeshaLabCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
