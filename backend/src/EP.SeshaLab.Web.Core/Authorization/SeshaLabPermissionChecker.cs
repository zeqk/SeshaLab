...
namespace EP.SeshaLab.Common.Authorization
{
    /// <summary>
    /// SeshaLab Permission checker
    /// </summary>
    public class SeshaLabPermissionChecker : ICustomPermissionChecker, ISeshaLabPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public SeshaLabPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
